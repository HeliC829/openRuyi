...
# OBS workers may lack /dev/ptmx or /dev/fd; skip only tests requiring those
# kernel-provided files while retaining the rest of the interpreter suite.
Patch2001:      2001-skip-unavailable-test-environments.patch
