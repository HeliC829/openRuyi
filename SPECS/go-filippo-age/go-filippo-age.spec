...
# OBS cannot capture prompts when testscript attaches command output as PTY
# input; the affected scenarios still verify encryption and decryption.
Patch2000:      2000-tolerate-limited-pty-output-capture.patch
